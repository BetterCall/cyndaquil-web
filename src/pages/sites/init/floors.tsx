...
import { CreateEmplacement } from "../../../components/emplacements";
        ...
        return (
          <>
            <li
              ...
              className={`cursor-pointer py-5 px-6 mb-3 bg-white shadow rounded ${
                isSelected ? " bg-body" : ""
              } `}
            >
              <button className="w-full flex justify-between items-center">
                <h3 className="text-sm font-bold">Etage : {floor.name}</h3>
              </button>
              <p className=" ml-5 mt-3 pr-6 text-sm text-gray-500">
            ...
            {isSelected && <CreateEmplacement floorId={floor.id} />}
          </>
        );
      })}
    </ul>
