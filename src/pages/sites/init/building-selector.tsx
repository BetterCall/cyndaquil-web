...
export const BuildingSelector: React.FC<IBuildingSelector> = ({
  id,
  name,
  isSelected,
}) => {
  ...
  const submit = async () => {
    ...
    try {
      ...
      client.writeFragment({
        id: `Building:${id}`,
        fragment: gql`
          fragment BuildingUpdateed on Building {
            name
          }
        `,
        data: {
