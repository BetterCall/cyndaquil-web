...
import { ContactsList, CreateContactForm } from "../../components/contacts";
...
export const Site = () => {
  ...
  const { data, loading, refetch } = useQuery<SiteQuery, SiteQueryVariables>(
    SITE,
    {
      variables: {
        id: +id!,
          ...
          <div className="w-full xl:w-1/2   px-4 mb-4 md:mb-0">
            <Card>
              ...
              <table className="table-auto w-full">
                ...
                <tbody>
                  {data?.site?.result?.buildings.map((building, index) => (
                    <tr
                    ...
                    >
                      <td className="flex py-3">
                        ...
                        <div>
                          <p
                            ...
                            onClick={() =>
                              navigate(`/sites/${id}/buildings/${building.id}`)
                            }
                          >
                            {building.name}
                          </p>
                      ...
                      <td className="font-medium">10 equipements</td>
