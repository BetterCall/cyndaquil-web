...
import { SearchEquipmentsInput } from "../../components/equipments";

import { Header } from "../../components/header";
import { parseParams } from "../../helpers/clean-object";
import { EQUIPMENTS } from "../../queries/equipments.queries";
import {
  EquipmentsQuery,
  EquipmentsQueryVariables,
} from "../../__generated__/EquipmentsQuery";
...
export const Equipments = () => {
  ...
  const [where, setParams] = useState<EquipmentFiltersInput>({});
  useEffect(() => {
              ...
              {data?.equipments?.results?.map((reference, index) => (
                ...
                >
                  <td className="flex py-3">
                    <div>
                      <p
                        ...
                        onClick={() => navigate(`/equipments/${reference.id}`)}
                      >
                  ...
                  <td className="text-right">
                    <span
                      onClick={() =>
                        navigate(`/equipments/${reference.id}/update`)
                      }
