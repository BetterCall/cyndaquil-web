...
import { EQUIPMENT_CATEGORY } from "../../queries/equipment-categories.queries";
...
import { RemoveBenefitModal } from "../../components/benefits/remove-benefit-modal";
...
export const EquipmentCategory = () => {
  const { id } = useParams<IEquipmentCategory>();
  ...
  return (
    <>
      <Header
        title={data?.equipmentCategory?.result?.name ?? ""}
          ...
          <div className="w-full xl:w-1/2 xl:pr-4 mb-4 md:mb-0">
            <Card>
              ...
              <table className="table-auto w-full">
                ...
                <tbody>
                  {data?.equipmentCategory?.result?.benefits?.map(
                    (benefit, index) => (
                      <tr
                      ...
                      >
                        ...
                        <td className="padding-table text-right">
                          <span
                            onClick={() =>
                              navigate(`benefits/${benefit.id}/update`)
                            }
              ...
              <table className="table-auto w-full">
                ...
                <tbody>
                  <tr className={`text-xs  bg-gray-50  `}>
                    <td className="padding-table">
                      <p className="font-medium  ">ADI PP6</p>
                    </td>
                    <td className="padding-table text-center">
                      <p className="font-medium  cursor-pointer">10 € HT</p>
                    </td>
