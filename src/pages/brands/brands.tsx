...
import { SearchBrands } from "../../components/brands";
import { Button } from "../../components/button";
import { Header } from "../../components/header";
import { SendIcon } from "../../components/icons";
import { parseParams } from "../../helpers/clean-object";
import { BRANDS } from "../../queries/brands.queries";
import {
  BrandsQuery,
  BrandsQueryVariables,
} from "../../__generated__/BrandsQuery";
...
export const Brands = () => {
  ...
  const [where, setParams] = useState<BrandsFiltersInput>({});
  useEffect(() => {
              ...
              {data?.brands?.results?.map((brand, index) => (
                ...
                >
                  ...
                  <td className="text-right padding-table ">
                    <span
                      onClick={() => navigate(`/brands/${brand.id}/update`)}
