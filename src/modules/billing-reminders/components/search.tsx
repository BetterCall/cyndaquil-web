...
export const SearchBillingRemindersInput: React.FC = (defaultValues) => {
  const navigate = useNavigate();
  const form = useForm<BillingRemindersFiltersInput>({
    defaultValues,
    mode: "all",
  });
          ...
          {isFormOpened && (
            <div className="px-4 ">
              <div className="flex flex-wrap -mx-4 -mb-4 md:mb-0">
                ...
                <div className="w-full md:w-1/3 p-3">
                  <UserInput form={form} inputName="madeById" />
                </div>
