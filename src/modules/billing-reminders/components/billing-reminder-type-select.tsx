...
import { BillingReminderType } from "../../../__generated__/globalTypes";
import { SelectOptionsWithTraductions } from "../../traductions/buttons";

interface IBillingReminderTypeSelect {
  form: UseFormReturn<any, any>;
}

export const BillingReminderStatusSelect: React.FC<
  IBillingReminderTypeSelect
> = ({ form }) => {
      ...
      <div className="relative">
        ...
        >
          ...
          <SelectOptionsWithTraductions
            selected={type}
            keys={Object.keys(BillingReminderType)}
          />
        </select>
      </div>
    </div>
