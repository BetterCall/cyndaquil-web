...
import { BugCriticalSelect } from "./bug-critical-select";

export const SearchBugInput: React.FC<BugFiltersInput> = (defaultValues) => {
  const navigate = useNavigate();

  console.log("default ", defaultValues);
  const form = useForm<BugFiltersInput>({
    defaultValues,
    mode: "onSubmit",
  });
