...
export const BugCriticalSelect: React.FC<IProps> = ({ form }) => {
  const value = form.watch("critical");
    ...
    <div className="w-full">
      ...
      <div className="relative">
        ...
        >
          ...
          <option selected={value === "true"} value={"true"}>
            Critique
          </option>
          <option selected={value === "false"} value={"false"}>
            Non Critique
          </option>
        </select>
      </div>
