...
import { CallSearchInput } from "../components";
import { parseParams } from "../../../helpers/clean-object";
import { useLazyCalls } from "../hooks";
...
export const Calls = () => {
  ...
  const [search, { loading, data, fetchMore, error }] = useLazyCalls();
              ...
              {data?.calls?.results?.map((call, index) => (
                ...
                >
                  ...
                  <td className=" padding-table text-right">
                    <span
                      onClick={() => navigate(`/call/${call.id}/update`)}
