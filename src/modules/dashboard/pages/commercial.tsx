      ...
      <section className="py-8 px-6 bg-white mb-5">
        <div className="flex flex-wrap -mx-3 items-center">
          <div className="w-full lg:w-1/2 flex items-center mb-5 lg:mb-0 px-3">
            ...
            <div>
              <h2 className="mb-1 text-2xl font-bold">Dashboard</h2>
              <p className="text-sm text-gray-500 font-medium">
                Bonjour {meData.me?.firstname}
              </p>
            </div>
          </div>
          <div className="w-full lg:w-auto ml-auto px-3"></div>
        </div>
      </section>
        ...
        <section className="section">
          ...
          <div className="element">
            <div className="card">
              ...
              <VisitsPreview userId={meData?.me?.id} />
            </div>
          </div>
        </section>
      </div>
