...
export const CustomerForm: React.FC<ICustomerForm> = ({
  ...
  return (
    <section className="section">
      <div className="left">
        <div className="card">
          <FormHeader
            ...
            subtitle="Modifier les informations générales du client"
          />
              ...
              <div className="w-full p-3 ">
                <div className="flex flex-wrap">
                  <div className="w-full">
                    ...
                    <textarea className="block w-full h-64 p-4 input text-base text-coolGray-900 font-normal"></textarea>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="right">
        <div className="card">
          <FormHeader title="Adresse" subtitle="Modifier l'adresse du client" />
