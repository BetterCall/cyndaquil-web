  ...
  return (
    <div className=" bg-body min-h-screen ">
      ...
      >
        ...
        ></div>
        <nav className="fixed z-50 top-12 left-0 bottom-0 flex flex-col w-3/4 xl:w-64 sm:max-w-xs pt-4 pb-8 bg-white overflow-y-auto transition-all">
          <div className="px-4 pb-6">
            <ul className="mb-8 text-sm font-medium">
              ...
              <ExpendableLink icon={<SendIcon />} title="Appels" url="/calls" />
              <ExpendableLink
                icon={<SendIcon />}
                title="Fournisseurs"
                url="/suppliers"
      ...
      >
        <div className=" min-h-screen  bg-body ">{children}</div>
      </div>
    </div>
  );
};
